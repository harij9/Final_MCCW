...
export default function Home({ campaigns }) {
  ...
  return (
    <div>
      <Head>
        <title>My Carbon Credit Watch</title>
        <meta
          name="description"
          content="Transparent Crowdfunding using blockchain for Carbon credits generating projects"
        />
      ...
      <main className={styles.main}>
        ...
        <Container py={{ base: "4", md: "12" }} maxW={"7xl"} id="howitworks">
          <HStack spacing={2}>
            <SkeletonCircle size="4" />
            <Heading as="h2" size="lg">
              How My Carbon Credit Watch Works
            </Heading>
          </HStack>
          <Divider marginTop="4" />
          <SimpleGrid columns={{ base: 1, md: 3 }} spacing={10} py={8}>
